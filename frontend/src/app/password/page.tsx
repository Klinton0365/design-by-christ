          ...
          <form className="flex w-full max-w-[480px] flex-col items-center gap-10">
            <label className="flex w-full flex-col">
              ...
              <input
                ...
                className="w-full border-0 border-b border-black bg-transparent pb-3 font-body text-[20px] text-body placeholder:text-body focus:outline-none sm:text-[22px]"
              />
            </label>
            <button
              type="submit"
              className="inline-flex items-center justify-center gap-2.5 rounded-[18px] bg-dark px-9 py-6 font-body text-[18px] font-semibold text-white shadow-[0px_10px_20px_rgba(192,192,192,0.35)] transition-opacity hover:opacity-90"
            >
              Submit Now
